...
# a primeira variável é um retorno, ou seja, após a verificação, ela que será retornada depois é feito um laço for
# convencional (for numero in numeros), onde todos os elementos da lista irão para a variável "numero" colocar ou não
# a condicional (if). o interpretador faz primeiro o laço for, depois disso ele faz a  verificação da condicional e
# depois desse processo, é retornado a variável local contendo o resultado de tudo isso
